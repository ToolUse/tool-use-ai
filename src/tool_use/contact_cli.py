...
def submit_feedback():
    ...
    if answers:
        ...
        data = {
            "subject": subject,
            "text": text,
            "email": user_email  # Changed from user_email to email
        }

        try:
            url = "https://tyfiero-tool_use_feedback.web.val.run"  # Updated URL
            headers = {
            ...
            console.print(Panel(f"Thank you for your submission! Server response: {response.text}", style="green"))
